...
const getWeeklyTemplate = delegatorTemplateData => {
  ...
  const body = {
    ...
    missedRewardCalls,
    share1: utils.tokenAmountInUnits(share1),
    share2: utils.tokenAmountInUnits(share2),
    share3: utils.tokenAmountInUnits(share3),
    share4: utils.tokenAmountInUnits(share4),
    share5: utils.tokenAmountInUnits(share5),
    share6: utils.tokenAmountInUnits(share6),
    share7: utils.tokenAmountInUnits(share7),
    fromDateCardinal,
    toDateCardinal,
    startRoundDate,
    endRoundDate
