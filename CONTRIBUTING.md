Contributing to Livepeer Alerts Backend
=======================

_Thanks for considering contributing to Livepeer Alerts Backend!_
...
[issue tracker](https://github.com/protofire/livepeer-alerts-backend/issues).
...
Clone this repository and install npm dependencies:
    ...
    $ git clone git@github.com:protofire/livepeer-alerts-backend.git
    $ cd livepeer-alerts-backend
    $ npm install
